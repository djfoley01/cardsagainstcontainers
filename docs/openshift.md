...
podman tag cards-against-containers:0.3.0 \
  "$REGISTRY/happyhour/cards-against-containers:0.3.0"
podman push "$REGISTRY/happyhour/cards-against-containers:0.3.0"
```
